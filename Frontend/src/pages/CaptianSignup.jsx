  ...
  const [email,setEmail]=useState('')
    ...
    return (
      <div className='p-7 h-screen flex flex-col justify-between'>
            <div>
              <img className="w-16 mb-10" src="https://static.vecteezy.com/system/resources/previews/027/127/594/non_2x/uber-logo-uber-icon-transparent-free-png.png" alt="Uber Logo"/>
             <form onSubmit={(e)=>{
                 submitHandler(e)
             }}>
              <h3 className='text-lg w-full font-medium mb-2'>What's our Captian's Name</h3>
              <div className='flex gap-4 mb-5'>
                 ...
                 <h3 className='text-base font-medium mb-2'>what's our Captian's Email</h3>
                 <input
